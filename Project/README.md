...
- 🛠️ **Excel Features:** Used map chart feature to plot median salaries globally.
...
- 👁️ **Visual Enhancement:** Improved readability and quick understanding of geographic salary trends.
